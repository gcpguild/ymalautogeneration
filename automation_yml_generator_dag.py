...
arg_def_help_dict = {
        ...
        '--r': ('asia-south1', 'GCP Region'),
        '--c': ('composer_cluster_id', 'Composer cluster name'),
...
# validate_emailing if valid email ID is provided in argument --e

validate_email_id(args.e)
...
for i in range(0, len(tagsin)):
    tagstasklst1.append(sq(tagsin[i]))
